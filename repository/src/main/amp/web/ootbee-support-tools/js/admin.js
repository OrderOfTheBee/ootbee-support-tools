 ...
 */
// The Admin root object has been extracted from the Alfresco admin-template.ftl to
// trim down page HTML sizes and promote reuse
...
(function() {
   ...
   Admin.togglePassword = function togglePassword(id, button)
   {
      ...
      {
         button.value = _messages.passwordHideEncoded;
         field.type = "text";
      }
      else
      {
         button.value = _messages.passwordShowEncoded;
         field.type = "password";
      }
   }
