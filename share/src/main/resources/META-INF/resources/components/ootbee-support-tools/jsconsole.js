...
(function()
{
   ...
   /**
     ...
     * @constructor
     */
   OOTBee.JavaScriptConsole = function(htmlId)
   {
...
//             Dom.addClass(parent.widgets.refreshButton, 'refresh-button');
   ...
   YAHOO.extend(OOTBee.JavaScriptConsole, Alfresco.ConsoleTool,
   {
      ...
      onReady: function ACJC_onReady()
      {
         ...
         var uiMirrorScript = new CodeMirrorUI(this.widgets.scriptInput, {imagePath:Alfresco.constants.URL_RESCONTEXT+'components/ootbee-support-tools/codemirror-ui/images', searchMode:'no'} ,{
             mode : "javascript",
...
// CodeMirror.tern.updateArgHints(cm);
         ...
         var uiMirrorTemplate = new CodeMirrorUI(this.widgets.templateInput, {imagePath:Alfresco.constants.URL_RESCONTEXT+'components/ootbee-support-tools/codemirror-ui/images', searchMode:'no'} , {
             lineNumbers: true,
             lineWrapping: true,
             mode:"freemarker",
             styleActiveLine: true,
      ...
      // Attach the CodeMirror highlighting
         var uiMirrorJSON = new CodeMirrorUI(this.widgets.jsonOutput, {searchMode:'no', imagePath:Alfresco.constants.URL_RESCONTEXT+'components/ootbee-support-tools/codemirror-ui/images'} , {
